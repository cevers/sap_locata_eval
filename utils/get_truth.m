function truth = get_truth(array_name, position_array, position_source, required_time)

% truth = get_truth(array_name, position_array, position_source, required_time)     
